...
const MuiButton = () => {
  ...
  return (
    ...
    <Stack spacing={2} direction='row'>
        <Button variant='contained' startIcon={<SendIcon/>} disableElevation disableRipple onClick={() => {alert('Clicked')}}>Send</Button>
    ...
    <Stack direction='row'>
        <ToggleButtonGroup aria-label='text formatting' value={formats} onChange={handleFormatChange} color='primary' orientation='vertical' exclusive>
